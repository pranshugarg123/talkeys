...
import image from "../../public/images/verify.png"
...
export default function Component() {
  return (
    <div className="flex h-[88.2vh] bg-transparent text-white p-8">
      ...
      <h1 className="text-6xl font-bold mb-4">Your event is sent for verification</h1>
      <h4 className="text-2xl mb-8">It will be listed once it is approved by team Talkeys</h4>
        <Link
          href="/"
