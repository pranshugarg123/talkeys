...
const EventCard = memo(
  ({
    event,
    index,
    // onOpenDialog, // We'll no longer call this on "More info" click
  }: {
    event: Event;
    index: number;
    // onOpenDialog: (event: Event) => void; // Not used now
  }) => {
            ...
            {sortedEvents.map((event, index) => (
              ...
              >
                <EventCard
                  event={event}
                  index={index}
                  // onOpenDialog={handleOpenDialog} // No longer used
                />
              </motion.div>
            ))}
          </div>
